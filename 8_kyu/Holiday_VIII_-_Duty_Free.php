 ...
 */
 ...
 function dutyFree(int $precioNormal, int $descuento, int $precioViaje): int {
    $precioConDescuento = $precioNormal - ($precioNormal * $descuento / 100);
    $ahorroPorBotella = $precioNormal - $precioConDescuento;

    return intval($precioViaje/$ahorroPorBotella);
